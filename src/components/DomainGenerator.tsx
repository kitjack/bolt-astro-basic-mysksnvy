...
export default function DomainGenerator() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `${businessName}-domains.txt`;
    ...
    <div className="flex gap-8">
      <div className="flex-1">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Generate Your Domain Names</h2>
              <p className="text-gray-600">Enter your business name below to generate domain suggestions</p>
            </div>
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-astro-blue group-hover:bg-astro-blue/5 transition">
                    {getCategoryIcon(category.icon)}
                  </div>
                  <span className="text-gray-900">{category.name}</span>
                </div>
                <span className="text-sm text-astro-blue bg-white px-3 py-1 rounded-lg">
                  {category.count}
                </span>
              </a>
            ))}
